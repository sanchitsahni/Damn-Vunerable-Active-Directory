#!/usr/bin/env python3
# ==============================================================================
# validator.py — EMPIRE / EMPIRE attack-combination checker.
#
...
def emit_text(c, graph, results, args):
    print(f"\n{c.BLD}{'='*74}{c.RST}")
    print(f"{c.BLD} EMPIRE / EMPIRE — Attack-Combination Reachability Checker (STATIC){c.RST}")
...
def main():
    p = argparse.ArgumentParser(
        description="EMPIRE/EMPIRE attack-combination reachability checker "
