...
| 3 | M3: Verification Tooling | Implement `scripts/check_docs.py` to parse roles/docs, verify >95% coverage and valid Mermaid. | M1, M2 | IN_PROGRESS |
| 4 | M4: Documentation Updates | Update/create Markdown documentation files with detailed explanations, terminal/PowerShell commands, and Mermaid diagrams. | M2, M3 | PLANNED |
| 5 | M5: Verification & Sign-off | Run static validation script, achieve 100% verification, and output final report. | M4 | PLANNED |
